...
export default function InboxPage() {
  ...
  const inboxMessages = messages.filter(m => m.state === "inbox" || m.state === undefined);
      ...
      <div className={`flex flex-col border-r border-gray-200 ${selected ? "hidden md:flex md:w-80 lg:w-96" : "flex w-full"}`}>
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-400">{inboxMessages.length} messages</p>
          </div>
        ...
        <MessageList
          ...
          emptySubtext="Messages sent to your wallet will appear here"
        />
      </div>
